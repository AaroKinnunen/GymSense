...
public class Magneto_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mListener.setMagLine(mLineData,mChart);
        return view;
    }
    @Override
    ...
    private void initLinAccChart(LineChart ln){
        ...
        ln.getDescription().setText("Magneto");
    ...
    public interface OnFragmentInteractionListener {
        void setMagLine(LineData ln, LineChart lc);
    }
