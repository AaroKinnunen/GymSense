...
public class Gyro_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mListener.setGyroLine(mLineData,mChart);
        return view;
    }
    @Override
    ...
    private void initLinAccChart(LineChart ln){
        ...
        ln.getDescription().setText("Gyro");
    ...
    public interface OnFragmentInteractionListener {
        void setGyroLine(LineData ln, LineChart lc);
    }
